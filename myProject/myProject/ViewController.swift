                    ...
                    if doCheckSocked() {
                        ...
                        if  chDev != "No" {
                            ...
                            if chNick != "No" {
                                ...
                                self.errmessage = "Current user blocked"
                            }
                        } else {
                            self.errmessage = "Current imai end device ID not supported"
                        }
                    } else {
                        self.errmessage = "Server address not supported"
                    }
